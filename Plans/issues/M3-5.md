...
Execute this tooling issue autonomously. Routine implementation and test decisions are allowed.
For material scope or verification decisions, choose the lowest-risk option, log it in
`Plans/decision-log.md`, and continue without waiting for approval. Finish as `DONE`, `PARTIAL`, or
